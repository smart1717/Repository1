...
@Document(indexName="idx_bos",type="waybill")//es的文档索引标识
public class WayBill {

	@Id
	@GeneratedValue
	@Column(name = "C_ID")
	@org.springframework.data.annotation.Id//sde的id标识
	...
	@Field(type=FieldType.String,index=FieldIndex.analyzed,analyzer="ik",searchAnalyzer="ik",store=true)
